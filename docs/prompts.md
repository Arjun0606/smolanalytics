...
never guesses. That's enforced in CI: [the agreement test](../internal/api/agreement_test.go)
...
A prompt is nothing exotic: instructions over the same 43 tools your model already has.
