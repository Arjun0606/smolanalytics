...
// FetchQueries pulls top queries for the trailing `days` (GSC data lags ~2 days,
// so the window ends day-2 — the honest window, not the wishful one).
