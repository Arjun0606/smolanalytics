...
// Delete removes a marker by id. found is true only when a marker actually went
// away; an id that matches nothing is not an error (deleting twice is a legitimate
