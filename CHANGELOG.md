...
- MCP server (stdio + Streamable HTTP) with 79 tools + 14 built-in prompts, including `whats_notable` (the "what to fix" verdict) — point your own Claude/Cursor at it and ask in plain English.
