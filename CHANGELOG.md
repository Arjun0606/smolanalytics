...
- MCP server (stdio + Streamable HTTP) with 43 tools including `whats_notable` (the "what to fix" verdict) — point your own Claude/Cursor at it and ask in plain English.
